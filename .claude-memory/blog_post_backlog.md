...
- **11 posts shipped** (covered). Four more landed between 2026-05-08 and 2026-05-24: cold-start telemetry, mobile-took-20-hours (was strong-candidate), migrate-on-startup, and the silent-`string.Join(record)` post.
- **12 strong catch-up candidates** (10 from corpus + 2 added today from the pre-reference-capture arc retro; minus the now-shipped mobile-took-20-hours).
